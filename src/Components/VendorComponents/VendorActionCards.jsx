...
const actions = [
  { label: "Add Job", 
    ...
    image: "https://wallpaperaccess.com/full/6442860.jpg"},

  { label: "Update Job", 
    component: <UpdateJob />, 
    icon: "fas fa-edit", 
    image: "/images/update-job.jpg" },

  { label: "Check Applications", 
    component: <ViewApplicant {...applicantData} />, 
    type: "applicants", 
    icon: "fas fa-clipboard-list", 
    image: "/images/check-applications.jpg" },

  { label: "Add Service", 
    component: <AddService />, 
    icon: "fas fa-plus-circle", 
    image: "/images/add-service.jpg" },

  { label: "Update Service", 
    component: <UpdateService />, 
    icon: "fas fa-edit", 
    image: "/images/update-service.jpg" },
